                        ...
                        <div class="col-lg-12">
                            <div class="contenet-hero">
                                ...
                                <a href="#" class="view-case scroll-down scroll-to">Scroll Down <img
                                        src="{{asset('public/assets/img/arrow-right-wight.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-seat box-seat-full">
                    <div class="container-fluid">
                        <div class="inner-img" data-dsn-grid="move-up">
                            <img src="{{asset('public/assets/img/pexels.jpg')}}" alt="" data-dsn-y="30%" data-dsn-scale="1">
                        </div>
                        <div class="pro-text">
                ...
                <section class="intro-about section-margin section-padding hidden">
                    ...
                    <div class="container">
                        <div class="row align-items-center h-100">
                            <div class="col-lg-6">
                                <div class="box-im">
                                    <div class="cover-bg" data-image-src="{{asset('public/assets/img/skills.jpg')}}"></div>
                                </div>
                            </div>
                        ...
                        <div class="custom-container">
                            <div class="slick-slider">
                                <div class="team-item slick-slide">
                                    <div class="box-img">
                                        <img src="{{asset('public/assets/img/team/1.png')}}" alt="">
                                    </div>
                                ...
                                <div class="team-item slick-slide">
                                    <div class="box-img">
                                        <img src="{{asset('public/assets/img/team/2.png')}}" alt="">
                                    </div>
                                ...
                                <div class="team-item slick-slide">
                                    <div class="box-img">
                                        <img src="{{asset('public/assets/img/team/3.png')}}" alt="">
                                    </div>

                                    <div class="box-content">
                                        <h4>Shazil</h4>
                                        <p>Animater Grapher</p>
                                    </div>
                                </div>
