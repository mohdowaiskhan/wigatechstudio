                    ...
                    <div class="swiper-wrapper">
                        <div class="slide-item swiper-slide">
                                ...
                                <div class="slide-content-inner">
                                    ...
                                    <div class="title-text-header">
                                        <div class="title-text-header-inner">
                                            ...
                                            BE THE BRAND ON EVERYONE'S LIPS
                                            </a>
                                        </div>
                                    </div>

                                    <p>Create your brand the way you want through Wiga Studios.</p>
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/01.jpg')}}" data-overlay="0">
                                    <img src="{{asset('public/assets/img/slider/01.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/02.jpg')}}"
                                    data-overlay="4">
                                    <img src="{{asset('public/assets/img/slider/02.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/03.jpg')}}"
                                    data-overlay="0">
                                    <img src="{{asset('public/assets/img/slider/03.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/04.jpg')}}"
                                    data-overlay="2">
                                    <img src="{{asset('public/assets/img/slider/04.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/05.jpg')}}"
                                    data-overlay="2">
                                    <img src="{{asset('public/assets/img/slider/05.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/06.jpg')}}"
                                    data-overlay="5">
                                    <img src="{{asset('public/assets/img/slider/06.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/07.jpg')}}"
                                    data-overlay="2">
                                    <img src="{{asset('public/assets/img/slider/07.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/08.jpg')}}"
                                    data-overlay="0">
                                    <img src="{{asset('public/assets/img/slider/08.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide-item swiper-slide">
                            ...
                            <div class="image-container">
                                <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/09.jpg')}}"
                                    data-overlay="4">
                                    <img src="{{asset('public/assets/img/slider/09.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="nav-slider">
                <div class="swiper-wrapper" role="navigation">
                    <div class="swiper-slide">
                        <div class="image-container">
                            <div class="image-bg cover-bg" data-image-src="{{asset('public/assets/img/slider/01.jpg')}}"
                                data-overlay="2">
                            </div>
                        </div>
                        <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="intro-content-text">
                                ...
                                Wigs Tech is a creative team that turns talks into walks, and we have this motto that says “Work Together. Grow Together” At Wiga Studio, you will find us coding, designing, and inventing new solutions of today and tomorrow. We have methodologies and approaches to change with the flow but our motto remains constant...</p>
                                ...
                                <div class="exper">
                                    <div class="numb-ex">
                                        <span class="word" data-dsn-animate="text">05</span>
                                    </div>
                    ...
                    <div class="img-box">
                        <div class="img-cent" data-dsn-grid="move-up">
                            <div class="img-container">
                                <img data-dsn-y="30%" src="{{asset('public/assets/img/bgg.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="services-item">
                                ...
                                <div class="icon">
                                    <img src="{{asset('public/assets/img/services/1.png')}}" alt="">
                                </div>
                                <div class="services-header">
                                    <h3>2D Animation</h3>
                                </div>
                                <p>We create animated videos tailored to your requirements to suit your business needs,
                                 target audience, and marketing objective.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="services-item selected">
                                ...
                                <div class="corner corner-bottom"></div>
                                <div class="icon">
                                    <img src="{{asset('public/assets/img/services/2.png')}}" alt="">
                                </div>
                                <div class="services-header">
                                <h3>3D Animation</h3>
                                </div>
                                <p>We have one of the best VFX and animation house to get you the desired delivery!</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="services-item">
                                ...
                                <div class="corner corner-bottom"></div>
                                <div class="icon">
                                    <img src="{{asset('public/assets/img/services/3.png')}}" alt="">
                                </div>
                                <div class="services-header">
                                    <h3>Frame By Frame  Animation</h3>
                                </div>
                                <p>24 Frames per seconds is what we do! Keeping the animation so smooth that it could mesmerize the viewer.</p>
                            </div>
                        </div>
                         ...
                         <div class="col-md-3">
                            <div class="services-item">
                                ...
                                <p>We are committed to breaking the creative horizons. 
                                We don’t limit ourselves, instead revitalize ourselves with crazy ideas!.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-seat box-seat-full section-margin">
                <div class="container-fluid">
                    <div class="inner-img" data-dsn-grid="move-up">
                        <img data-dsn-scale="1" data-dsn-y="30%" src="{{asset('public/assets/img/project/project2/3.jpg')}}" alt="">
                    </div>
                    <div class="pro-text">
                        ...
                        <div class="col-lg-9 offset-lg-3">
                            <div class="work-container">
                                <div class="slick-slider">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('public/assets/img/project/project4/1.jpg')}}" alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-lg-6 ">
                            <div class="box-im" data-dsn-grid="move-up">
                                <img class="has-top-bottom" src="{{asset('public/assets/img/project/project9/7.jpg')}}" alt=""
                                    data-dsn-move="20%">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="box-info">
                                ...
                                <div class="vertical-title" data-dsn-animate="up">
                                    <h2>What’s NFT? We’re best at NFT art!.</h2>
                                </div>

                                <h6 data-dsn-animate="up">NFT means ‘Non Fungible Token’,
                                 but what does it really mean? Well,
                                  it will help if you first understand what a ‘Fungible Token’ is.
                                    If we consider in terms of money: a 100 dollar 
                                    bill can be exchanged with five 20 dollar bills and still hold the equal value,
                                 which means a 100 dollar bill is a fungible token..</h6>
                    ...
                    <div class="inner">
                        ...
                        <div class="items">
                            ...
                            <div class="slick-slider">
                                <div class="item">
                                    <div class="quote">
                                        <p>"Hammad was amazing with completing exactly what we wanted to get.
                                         Patient and very helpful! Going to definitely hire him again very soon!!"
</p>
                                    </div>
                                    <div class="bottom">
                                        <div class="avatar">
                                            <img src="{{asset('public/assets/img/avatar/1.jpg')}}" alt="">
                                        </div>
                                        <div class="label">
                                            <div class="cell">~ Charlie, Sneaky Squirrel NFT</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="quote">
                                        <p>"Hammad did a great job at producing our animated video. He produced a storyboard,
                                         animation, and created multiple revisions for us. No complaints"</p>
                                    </div>
                                    <div class="bottom">
                                        <div class="avatar">
                                            <img src="{{asset('public/assets/img/avatar/2.jpg')}}" alt="">
                                        </div>
                                        <div class="label">
                                            <div class="cell">~ Ryan, Datafly</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="quote">
                                        <p>"I am extremely happy with the delivery of the project and the quality of work Ghazanfar put into my project.
                                         Going in, I honestly did not know what to expect and had a sense of skepticism of how the
                                          video project would turn out. I was not only surprised at the detail-oriented animation and
                                           sound effects of the video but was completely blown away at the level of talent
                                            and the alignment in the project vision. If you're looking for someone who is reliable, 
                                            professional, and can bring your project vision to life, I highly recommend Ghazanfar!"</p>
                                    </div>
                                    <div class="bottom">
                                        <div class="avatar">
                                            <img src="{{asset('public/assets/img/avatar/3.jpg')}}" alt="">
                                        </div>
                                        <div class="label">
                                            <div class="cell">~ Yohan </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="item">
                                    <div class="quote">
                                        <p>"I did enjoyed working with Ghazanfar. From the start he was really helpful and cooperative. 
                                        He was immediately enthousiastic about our project and really thought with us about the 
                                        design of the base model and the future designs of the project. 
                                        He was even willing to get into a call with us to help us to the process.
                                         He spoke fluent English and most of all, the quality of work was excellent!"
</p>
                                    </div>
                                    <div class="bottom">
                                        <div class="avatar">
                        ...
                        <div class="slick-slider">
                            <div class="item-new slick-slide">
                                <div class="image" data-overlay="5">
                                    <img src="{{asset('public/assets/img/blog/1.jpg')}}" alt="">
                                </div>
                                <div class="content">
                            ...
                            <div class="item-new slick-slide">
                                <div class="image" data-overlay="5">
                                    <img src="{{asset('public/assets/img/blog/2.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="background"></div>
                                    <h5>Web , Brand</h5>
                            ...
                            <div class="item-new slick-slide">
                                <div class="image" data-overlay="5">
                                    <img src="{{asset('public/assets/img/blog/3.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="background"></div>
                                    <h5>Web , Brand</h5>
            ...
            <section class="brand-client section-margin">
                <div class="container">
                    ...
                    <div class="wapper-client">
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/1.png')}}" alt="">
                        ...
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/2.png')}}" alt="">
                        ...
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/3.png')}}" alt="">
                        ...
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/4.png')}}" alt="">
                        ...
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/5.png')}}" alt="">
                        ...
                        <div class="logo-box">
                            <img src="{{asset('public/assets/img/logo/6.png')}}" alt="">
